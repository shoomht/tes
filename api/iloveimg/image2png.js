...
async function scrapeImageToPngFromUrl(imageUrl) {
...
async function scrapeImageToPngFromFile(fileBuffer, fileName) {
    const converter = new CompressImageAPI();
    await converter.getTaskId();
...
export default [
    {
        ...
        name: "image2png",
        category: "Iloveimg",
        description: "Convert an image to PNG format by providing its URL.",
