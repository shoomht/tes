...
async function scrapeCombotSticker(q, page) {
    try {
        const response = await axios_1.default.get(proxy() + `https://combot.org/stickers?q=${encodeURIComponent(q)}&page=${page}`, {
            headers: {
...
export default [
    {
        ...
        name: "combot sticker",
        category: "Sticker",
        description: "This API allows you to search for Telegram sticker packs on Combot.org.",
