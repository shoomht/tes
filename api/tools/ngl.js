...
async function submitAnswer(question, urlString) {
    try {
        ...
        const { data } = await axios_1.default.post(proxy() + "https://ngl.link/api/submit", postData.toString(), axiosConfig);
        return data;
    }
    catch (error) {
...
export default [
    {
        ...
        name: "ngl",
        category: "Tools",
        description: "This API endpoint allows you to send anonymous messages to an NGL.link profile.",
