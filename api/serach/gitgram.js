...
async function scrapeChordsSearch(music) {
    try {
        const searchUri = `https://www.gitagram.com/index.php?cat=&s=${encodeURIComponent(music)}`;
        const { data } = await axios_1.default.get(searchUri, {
            timeout: 30000,
            headers: {
...
async function scrapeChordsDetail(url) {
    try {
...
export default [
    {
        ...
        name: "gitagram",
        category: "Search",
        description: "This API endpoint allows users to search for music chords on Gitagram by providing a music title or artist.",
