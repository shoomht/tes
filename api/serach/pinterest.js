    ...
    async makeRequest(params, isPost = true) {
        ...
        try {
            const response = isPost
                ? await axios_1.default.post(url.toString(), new URLSearchParams(params).toString(), {
                    headers: { ...this.headers, "x-pinterest-source-url": `/search/pins/?q=${encodeURIComponent(params.query)}&rs=typed` },
                    responseType: "json",
                    decompress: true,
                })
                : await axios_1.default.get(this.baseUrl + "?" + new URLSearchParams(params), {
...
export default [
    {
        ...
        name: "pinterest",
        category: "Search",
        description: "This API endpoint allows you to search for various media types on Pinterest, including images, videos, and GIFs.",
