...
async function scrapeTagihanListrik(nopel) {
    try {
        const response = await axios_1.default.get(`https://listrik.okcek.com/dd.php?nopel=${nopel}`, {
            headers: {
...
export default [
    {
        ...
        category: "Check",
        description: "This API endpoint allows you to check your monthly PLN electricity bill information using your customer number (nopel...",
