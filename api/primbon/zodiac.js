...
async function scrapeZodiak(zodiak) {
    try {
        const { data } = await axios_1.default.get(`https://primbon.com/zodiak/${zodiak}.htm`, {
            headers: {
...
export default [
    {
        ...
        name: "zodiak",
        category: "Primbon",
        description: "This API endpoint retrieves detailed information for a specific zodiac sign from Primbon.",
