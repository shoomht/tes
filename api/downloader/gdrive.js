...
async function driveScrape(url) {
    try {
        ...
        const res = await axios_1.default.get(url, { timeout: 30000, headers: { "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36" } }).then((v) => v.data);
...
export default [
    {
        ...
        name: "gdrive",
        category: "Downloader",
        description: "This API endpoint allows you to obtain a direct download link for a Google Drive file by providing its public URL.",
