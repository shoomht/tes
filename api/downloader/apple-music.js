...
async function scrape(url, turnstileToken) {
    try {
        const resHome = await axios_1.default.get("https://aplmate.com/");
        ...
        const resApi = await axios_1.default.post("https://aplmate.com/action", formData, {
            headers: {
        ...
        const resTrack = await axios_1.default.post("https://aplmate.com/action/track", trackFormData, {
            headers: {
                "authority": "aplmate.com",
                "accept": "*/*",
                "accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7",
        ...
        let seoData = {};
        try {
            const resSeoData = await axios_1.default.get(url, {
                headers: {
        ...
        return {
            url: seoData.url || url,
            pageTitle: seoData.pageTitle || songTitle,
            description: seoData.description || "",
            keywords: seoData.keywords || "",
            songTitle: songTitle,
            artist: artist,
            artworkUrl: coverImage,
            appleTitle: seoData.appleTitle || songTitle,
            appleDescription: seoData.appleDescription || "",
            musicReleaseDate: seoData.musicReleaseDate || "",
...
export default [
    {
        ...
        name: "music apple",
        category: "Downloader",
        description: "This API endpoint allows users to retrieve music download links and SEO (Search Engine Optimization) data directly fr...",
