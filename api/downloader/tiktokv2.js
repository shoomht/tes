...
class TikTokScraper {
    ...
    async getDownloadLinks(URL) {
        try {
            ...
            const response = await axios_1.default.get("https://musicaldown.com/en", {
                headers: {
            ...
            const respon = await axios_1.default.request({
            ...
            if (slideButton.length > 0) {
                try {
                    ...
                    if (slideDataMatch) {
                        ...
                        const slideRes = await axios_1.default.request({
...
export default [
    {
        ...
        name: "tiktok v2",
        category: "Downloader",
        description: "This API endpoint allows you to download TikTok videos and photos by providing a TikTok URL.",
