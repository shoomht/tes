...
async function scrapeOploverzDownload(episodeUrl) {
    try {
        const { data } = await axios_1.default.get(proxy() + episodeUrl + "/", {
            headers: {
...
export default [
    {
        ...
        category: "Anime",
        description: "This API endpoint provides download links and details for anime episodes from Oploverz.",
