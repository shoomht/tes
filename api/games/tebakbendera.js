...
async function scrape() {
    try {
        const response = await axios_1.default.get("https://flagcdn.com/en/codes.json", {
            timeout: 30000,
            headers: {
        ...
        try {
            const srcResponse = await axios_1.default.get("https://raw.githubusercontent.com/BochilTeam/database/master/games/tebakbendera2.json", {
                timeout: 30000,
                headers: {
                    "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36",
                },
...
export default [
    {
        ...
        name: "tebak bendera",
        category: "Games",
        description: "This API endpoint provides a random country flag quiz.",
