...
const axiosInstance = (0, axios_cookiejar_support_1.wrapper)(axios_1.default.create({
    jar: new tough_cookie_1.CookieJar(),
    withCredentials: true,
}));
async function getInstagramProfile(username) {
    try {
        const response = await axiosInstance.get(`https://www.instagram.com/api/v1/users/web_profile_info/?username=${username}`, {
            headers: {
...
export default [
    {
        ...
        name: "instagram",
        category: "Stalker",
        description: "This API endpoint allows you to retrieve detailed profile information for any Instagram user by providing their usern...",
