...
async function getUserProfile(username, cookies = "") {
    ...
    const client = axios_1.default.create({ baseURL, headers });
    if (!cookies) {
        try {
...
export default [
    {
        ...
        name: "pinterest",
        category: "Stalker",
        description: "This API endpoint allows you to retrieve public profile information for a specified Pinterest user using their userna...",
